		...
		<div className='w-1/3 bg-gray-800 rounded-lg flex flex-col gap-8 items-center p-8'>
			...
			<form className='w-4/5 flex flex-col items-center gap-4' onSubmit={loginUser}>
				<input
					type='text'
					placeholder='email'
					className='w-full text-center p-2 text-xl tracking-widest rounded-md outline-none focus:outline-none'
					value={email}
				...
				/>
				<button
					className='text-white p-2 mt-2 rounded-md font-bold text-2xl tracking-wider uppercase'
					type='submit'
				>
					Submit
				</button>
